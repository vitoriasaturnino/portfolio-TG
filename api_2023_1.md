...
## Sobre o Projeto
<div align="justify">
    Neste semestre trabalhamos com uma empresa parceira que tem como objetivo produzir tecnologia e soluções fundamentais para autonomia nacional. A IACIT enfrentava um desafio crescente na gestão de solicitações e no atendimento aos seus clientes: a falta de centralização e organização eficiente das demandas. Com um volume elevado de solicitações provenientes de diferentes clientes, a gestão descentralizada dificultava o acompanhamento do status das ocorrências, gerava retrabalho e aumentava o risco de falhas no processo de resolução de problemas. Isso comprometia a qualidade do atendimento e a experiência do cliente, que não conseguia obter respostas rápidas e claras sobre o andamento de suas solicitações.
    <br><br>
...
<div align="justify">
  <b>Comunicação clara e assertiva</b>: Como Product Owner, eu precisava me comunicar de forma clara e objetiva com a minha equipe, já que era a única pessoa que conversava diretamente com o cliente. Era fundamental garantir que as necessidades e dores do cliente fossem bem entendidas por todos. Além de ouvir as dúvidas da equipe e as leva-las ao cliente para obter respostas, conseguir sanar as dúvidas manter o processo de desenvolvimento fluindo sem interrupções.
  <br><br>
  <b>Liderança</b>: Também precisei exercer minha liderança ao gerenciar as tasks, organizando o backlog e priorizando as atividades de cada sprint, sempre garantindo o MVP e o cumprimento dos prazos.
  <br><br>
  <b>Autonomia</b>: Durante o desenvolvimento da feature de anonimização de dados conforme a LGPD, precisei ter muita autonomia. Como o MongoDB era uma tecnologia nova para todos na equipe, precisei estudar sozinha e buscar soluções de forma independente para garantir a entrega dessa task.
</div>
